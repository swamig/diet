...
*   **The Mechanism:** Cancer initiation often begins with Reactive Oxygen Species (ROS) causing DNA damage. Sulforaphane is the most potent naturally occurring inducer of the Nrf2 pathway [[13]](../07-appendices/master-citations.md#13-metabolic-oncology--chemoprevention).
*   **The Protocol:** Nrf2 acts as a cellular "thermostat" for oxidative stress. When activated, it translocates to the nucleus and turns on over 200 antioxidant and Phase II detoxification genes [[10]](../07-appendices/master-citations.md#10-antioxidants-polyphenols--vascular-signaling). 
*   **Execution (The 50x Multiplier):** The protocol utilizes **[Broccoli Microgreens or Sprouts](../05-practical/protocol-broccoli.md)** rather than mature broccoli to maximize signaling efficiency [[4]](../07-appendices/master-citations.md#4-sulforaphane--inflammatory-control). 
    *   **The Raw Mandate:** Eaten raw in the **[14:30 Salad Layer](../05-practical/daily-salad-layer.md)** to preserve the *myrosinase* enzyme.
    *   **The Lysis Hack (300% Boost):** Utilizes the 24-hour **[Freeze-Thaw method](../05-practical/protocol-broccoli.md#the-sprout-freezing-hack-3x-potency)** to rupture cell walls and triple sulforaphane yield.

## 2. NF-κB Inhibition (The Inflammatory Blockade)
*   **The Mechanism:** Chronic inflammation is the "paving stone" for cancer, providing the cytokines necessary for tumor angiogenesis and metastasis [[1]](../07-appendices/master-citations.md#1-trp-receptor-cross-talk-menthol--capsaicin).
*   **The Protocol:** The protocol anchors the day with extreme inhibitors of this pathway:
