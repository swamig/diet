---
title: 'Batch Prep SOP — Hired Help'
section: 'practical'
type: 'procedure'
priority: 'high'
---
...
## Pre-Flight Checklist (Night Before — 30 Minutes)

Complete this the evening before batch day. Failures here delay the entire session.
...
|---|---|---|---|
| Pot 1 | Chickpeas batch A (~2.5 kg dry) | 3× water + 1 tsp sea salt | Tonight |
| Pot 2 | Chickpeas batch B (~2.5 kg dry) | 3× water + 1 tsp sea salt | Tonight |
| Pot 3 | Black beans batch A (~2.25 kg dry) | 3× water + 1 tsp sea salt | Tonight |
| Pot 4 | Black beans batch B (~2.25 kg dry) | 3× water + 1 tsp sea salt | Tonight |

Small bowl: fenugreek seeds for hair paste — cover with water, soak overnight.

### Labeling
Label all freezer bags and containers before batch day. Use masking tape + marker.  
Required labels:
- "Chickpeas WHOLE — [date]"
...
## Day 0 — Batch Cook (Morning Start)

### T+0:00 — Drain and Load (Both Stations, 20 min)

**Stove Station:**
1. Drain Pot 1 (Chickpeas A) — discard soak water. Rinse beans under cold water.
2. Refill Pot 1 with fresh cold water (cover beans by 3 inches). Add Boil Stack A (see recipe card).
3. Repeat for Pot 2 (Chickpeas B).
4. Drain Pot 3 (Black Beans A) — discard soak water. Rinse. Refill with fresh water. Add Boil Stack B.
5. Repeat for Pot 4 (Black Beans B).
6. Place all 4 pots on burners. Set all 4 burners to HIGH.

**Bench Station:**
1. Prep aloe vera: split leaves, scoop gel into cube trays. Fill 5 trays. Cover. Set aside.
2. Juice lemons: fill 4 cube trays with fresh lemon juice. Cover. Set aside.
3. Prep imli: dissolve tamarind block in warm water, strain, fill 1 cube tray. Cover.
...
> ❌ FAIL: Heavy foam still rising → continue skimming before reducing heat
...
## Day 1 Morning — Transfer to Chest Freezer (20 Minutes)

After 12–24h RS3 chill:

1. Pull all portioned bags and containers from batch fridge.
2. Probe check: Run thermometer through a bag — should read 35–40°F. If still slightly warm (above 45°F), something didn't chill properly — do not freeze yet, leave another 6h.

> **QC Gate 7 — RS3 Chill Confirmation:**  
> ✅ PASS: Probe reads ≤40°F throughout batch fridge load  
> ❌ FAIL: Any item above 45°F → do not freeze. Leave in fridge, recheck in 4h. Investigate: was fridge overloaded? Was food portioned too thick to chill through?

3. Transfer all frozen bags/containers to chest freezer. Organize by item type.
4. Transfer all set cube trays from kitchen freezer to a labeled gallon bag → store in chest freezer.
5. Return aquafaba and black bean liquid cube trays (if still in fridge) to kitchen freezer overnight; transfer tomorrow.

**Total active time Day 1:** ~20 minutes

---

## Labeling Standard

Every item in the chest freezer must have:
- Item name
- Format (whole / mashed / cube)
- Batch date
- Use-by date (3 months from batch date)

Example: `Black Beans WHOLE — 2026-05-05 — Use by 2026-08-05`
...
## Quick Reference: Day-Of Finishers (Not Batch Items)

When the owner warms frozen beans for serving, these are added fresh:
- 1 rested garlic cube → fold in at 130°F
- 1 drizzle EVOO → after heat off
- Pinch black salt → after heat off
- Fresh cilantro → after plating
- Fresh lemon squeeze → at table

**Helper never prepares these.** They are the owner's daily 3-minute finishing step.
...
- [Protocol Black Beans](protocol-blackbeans.md)
- [Protocol Chickpeas](protocol-chickpeas.md)
