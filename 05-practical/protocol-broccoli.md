...
## The Impact of Under-Dosing
Cutting the dose below the Clinical baseline (1/4 Cup) has the following physiological effects:
1.  **Reduced DNA Repair:** Sulforaphane is dose-dependent. A micro-dose may fail to reach the threshold required to trigger Keap1 dissociation, meaning 200+ protective genes remain "off."
2.  **Weakened Glucose Shield:** The fiber from the microgreens acts as a physical barrier. Reducing the volume allows starches to absorb faster, increasing the post-meal insulin spike.

## Detox vs. Maintenance Phase
This protocol does not use multi-month "detox" blocks. Instead, it utilizes a daily and weekly biological rhythm:
*   **Daily Rhythm:** The 06:30-14:30 window is the **Detox/Catabolic Phase** (AMPK/Autophagy). The 14:30 Microgreen dose acts as the final "flush" signal. The 16:30-21:00 window is the **Maintenance/Anabolic Phase** (mTOR).
