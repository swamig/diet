...
This section translates the protocol into kitchen operations. Read this before the 28-day cycle if execution friction is high or if the daily plan still feels too abstract.
...
- [The Protocol Masala Matcha (AMPK Multiplier)](protocol-matcha.md)
...
- Pre-portion the ingredients that recur every day.
- Separate cold and warm components so the protocol survives real life.
- Decide where logs, containers, and prep notes will live before the first week starts.

## Related Sections

- [Daily Execution](../03-execution/README.md) consumes the output of this section.
- [Monitoring](../06-monitoring/README.md) tracks whether the logistics layer is actually working.
- [Appendices](../07-appendices/README.md) holds fast reference tables.
