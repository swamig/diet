...
# Thermal Hormesis (Sauna & Cold Plunge)

Temperature is a powerful biological lever. When applied strategically, it forces vascular adaptation, flushes the lymphatic system, and modulates the autonomic nervous system. 

This protocol utilizes three distinct thermal methods to support an elite training load.

## Method 1: The Daily Maintenance (1 Cycle)
...
## Method 3: The Weekly "Vascular Flush" (3 Cycles Contrast)
**Goal:** Deep-tissue recovery and maximal lymphatic flushing.
*   **Timing:** 1x per week (e.g., Saturday Active Recovery). 
*   **The Protocol:** 
    1.  Sauna (10-15 min) ➔ Cold Plunge (2-3 min)
