...
title: 'Functional Samosas & Samosa Balls (Air-Fried)'
section: 'practical'
type: 'procedure'
priority: 'supporting'
---

# Functional Samosas & Samosa Balls (Air-Fried)
...
## Bio-Mechanical Rationale for Rotation
While Option 3 (Gluten-Free) provides high fiber, the protocol **mandates** a rotation between the Seitan (Options 1 & 2) and GF (Option 3) versions to respect the following biological rules:

1.  **Fiber Overload Prevention:** Option 3 contains ~16g of fiber (Psyllium + RS3). Stacking this daily on top of the 14:30 Daily Salad risks crossing the "Fiber Ceiling," leading to bacterial fermentation, bloating, and sluggish gastric emptying. On Heavy Lift days, blood flow must be prioritized for muscle recovery, not trapped in the GI tract managing a massive psyllium gel block.
...
## Formatting Options
1.  **Traditional Triangles:** Classic samosa shape.
