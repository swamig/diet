...
*   **The Core Study:** *Nutrients* (DOI: 10.3390/nu18030376). In vitro studies on macrophages demonstrated that combining capsaicin and menthol massively amplifies anti-inflammatory signaling pathways compared to isolated exposure.
...
*   **"End on Cold" (BAT Activation):** Søberg et al., 2021, *Cell Reports Medicine*. Demonstrates that cold water immersion followed by unassisted re-warming massively increases Brown Adipose Tissue (BAT) thermogenesis and fat oxidation.
...
*   **Cortisol Reduction:** Chandrasekhar et al., 2012, *Indian Journal of Psychological Medicine*. "A prospective, randomized double-blind, placebo-controlled study of safety and efficacy of a high-concentration full-spectrum extract of ashwagandha root in reducing stress and anxiety in adults."
...
*   **Tannin/Catechin Iron Blockade:** Zijp et al., 2000, *Critical Reviews in Food Science and Nutrition*. "Effect of tea and other dietary factors on iron absorption." Catechins (EGCG) in green tea/matcha aggressively bind to non-heme iron, preventing absorption. This establishes the 10:00 AM Tannin Deadline.
*   **Ascorbic Acid Amplifier:** NIH Office of Dietary Supplements. Vitamin C (used in the 12:00 Peppermint Jaljeera via lemon juice) chemically reduces non-heme iron into a highly absorbable state.
...
*   **Norwegian 4x4 Efficacy:** Helgerud, J., et al., 2007, *Medicine & Science in Sports & Exercise*. "Aerobic High-Intensity Intervals Improve VO2max More Than Moderate Training." Proves that 4x4 intervals at 90–95% HRmax are the gold standard for cardiac output.
*   **The AMPK "Afterburn" (Matcha/EGCG Multiplier):** Venables, M. C., et al., 2008, *The American Journal of Clinical Nutrition*. "Green tea extract ingestion, fat oxidation, and glucose tolerance in healthy humans." Demonstrates that green tea extract significantly increases fat oxidation *during and after* moderate-intensity exercise and improves insulin sensitivity, validating the 07:15 post-cardio Matcha hydration.
*   **Visceral Fat Reduction:** Boutcher, S. H., 2011, *Journal of Obesity*. "High-Intensity Intermittent Exercise and Fat Loss." Proves HIIT is superior for reducing abdominal and visceral fat compared to steady-state exercise.
*   **Mitochondrial Biogenesis:** Hood, D. A., 2001, *Journal of Applied Physiology*. "Mechanisms of exercise-induced mitochondrial biogenesis in skeletal muscle." Explains how HIIT activates the PGC-1α pathway to increase cellular energy capacity.
*   **Overtraining Syndrome (OTS) Prevention:** Meeusen, R., et al., 2013, *Medicine & Science in Sports & Exercise*. Consensus statement validating the use of recovery windows to prevent HPA axis exhaustion.
...
*   **Psyllium as a Prebiotic Fiber:** Jalanka, J., et al., 2019, *International Journal of Molecular Sciences*. "The Effect of Psyllium Husk on Intestinal Microbiota." Demonstrates that psyllium increases beneficial butyrate-producing bacteria, aligning with the protocol's microbiome hormesis goals.
*   **Mucilage Gel & Glucose Blunting (Basil/Sabja & Chia Seeds):** Vuksan, V., et al., 2007, *Diabetes Care*. "Supplementation of conventional therapy with the novel grain Salba." Validates that hydrocolloid seeds form a viscous mucilage that physically coats the intestinal lining, slowing glucose absorption. Furthermore, Razavi et al., 2009, *Food Hydrocolloids*, establishes that basil seed (*Ocimum basilicum*) extract possesses exceptionally high water-holding capacity and pseudo-plastic flow, making it an elite, rapid-swelling physical barrier for protecting the GI tract.
